<template>
	...
	<div v-else-if="quiz.data">
		<div
			class="bg-surface-amber-2 text-ink-amber-6 space-y-2 p-3 mb-4 rounded-lg leading-5"
		>
				...
				>
					...
					>
						<label
							...
							class="flex items-center bg-surface-gray-3 rounded-md p-3 mt-4 w-full min-w-0 cursor-pointer focus:border-amber-600"
						>
							<input
