<template>
	<div
		v-if="course.title"
		class="flex flex-col h-full rounded-xl overflow-hidden text-ink-gray-9 bg-white border border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300"
		style="min-height: 350px"
	>
		<div
			class="w-full h-[168px] bg-cover bg-center bg-no-repeat relative"
			:style="
				course.image
...
const gradientColor = computed(() => {
	let color = props.course.card_gradient?.toLowerCase() || 'amber'
