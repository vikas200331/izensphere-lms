...
class LMSEnrollment(Document):
	...
	def validate_expiry(self):
		...
		expiry_date = frappe.db.get_value("LMS Course", self.course, "expiry_date")
		if expiry_date and getdate(today()) > getdate(expiry_date):
			frappe.throw(_("This course has expired and is no longer available for enrollment."))
